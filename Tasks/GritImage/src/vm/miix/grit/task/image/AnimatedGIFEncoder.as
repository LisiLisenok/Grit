...
package vm.miix.grit.task.image
{
	...
	public class AnimatedGIFEncoder
	{
		...
		public function AnimatedGIFEncoder() {
		...
		* @param out stream on which GIF images are written.
		* @return false if initial write failed.
		* 
		*/
		public function start( out : IDataOutput ) : Boolean {
			reset(); 
		    var ok:Boolean = true;
		    closeStream = false;
			this.out = out;
