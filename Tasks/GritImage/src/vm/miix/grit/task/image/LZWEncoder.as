...
package vm.miix.grit.task.image
{
	...
	internal class LZWEncoder
	{
		...
		private function char_out(c:Number, outs:IDataOutput):void
		{
		...
		private function cl_block(outs:IDataOutput):void
		{
		...
		public function compress(init_bits:int, outs:IDataOutput):void
		...
		// ----------------------------------------------------------------------------
		public function encode( os : IDataOutput ) : void
		{
		...
		private function flush_char(outs:IDataOutput):void
		{
		...
		private function output(code:int, outs:IDataOutput):void
